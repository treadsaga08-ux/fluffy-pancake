...
# Symbols to monitor
symbols = ["BTCUSDT", "ETHUSDT", "SOLUSDT", "ADAUSDT", "DOTUSDT", "LINKUSDT", "XRPUSDT", "DOGEUSDT", "TRXUSDT", "ALGOUSDT", "BAKEUSDT", "THETAUSDT", "SUIUSDT", "AAVEUSDT","UNIUSDT", "AAVXUSDT","XLMUSDT","BCHUSDT", "LTCUSDT", "TONUSDT", "MNTUSDT", "NEARUSDT", "APTUSDT", "ETCUSDT", "WLDUSDT", "POLUSDT", "ICPUSDT", "ARBUSDT", "RENDERUSDT", "SEIUSDT", "FILUSDT"]
